...
<section class="panel">
    ...
    <div>
        <table class="table table-striped b-t text-small">
            <thead>
            <tr>
                <th class="th-sortable" data-toggle="class">名称</th>
                <th width="100">首页显示</th>
                <th width="150">团购结束日期</th>
                ...
                <tr height="40px">
                    ...
                    <td style="vertical-align:middle">
                       <a class="btn btn-info" href="${ctx}/admin/info/look/${info.id}/${navType}">查看</a>
                        ...
                        &nbsp;&nbsp;<a class="btn btn-info" href="${ctx}/admin/infoImage/update/${info.id}/${navType}">修改图片</a>
